...
class CustomTextField extends StatefulWidget {
  ...
  /// changed when the user text input
  /// field.
  /// {@endtemplate}
  final ValueChanged<Rect> onContentRectChanged;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<CustomTextEditingController>('controller', controller, defaultValue: null));
...
class _CustomTextFieldState extends State<CustomTextField> with AutomaticKeepAliveClientMixin {
  final GlobalKey<CustomEditableTextState> _editableTextKey = GlobalKey<CustomEditableTextState>();

  Set<InteractiveInkFeature> _splashes;
  InteractiveInkFeature _currentSplash;

  CustomTextEditingController _controller;
  CustomTextEditingController get _effectiveController => widget.controller ?? _controller;
  ...
  void didUpdateWidget(CustomTextField oldWidget) {
    ...
    if (widget.controller == null && oldWidget.controller != null)
      _controller = CustomTextEditingController.fromValue(oldWidget.controller.value);
  ...
  Widget build(BuildContext context) {
    ...
    final CustomTextEditingController controller = _effectiveController;
    ...
    Widget child = RepaintBoundary(
      child: CustomEditableText(
        ...
        onContentRectChanged: widget.onContentRectChanged,
