...
class CustomEditableText extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<CustomTextEditingController>('controller', controller));
...
class CustomEditableTextState extends State<CustomEditableText> with AutomaticKeepAliveClientMixin<CustomEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<CustomEditableText> implements TextInputClient, TextSelectionDelegate {
  Timer _cursorTimer;
  ...
  void _handleCaretChanged(Rect caretRect) {
    ...
    if (widget.onContentRectChanged != null) {
      widget.onContentRectChanged(caretRect);
    }
  ...
  void _startCursorTimer() {
    ...
    if (CustomEditableText.debugDeterministicCursor)
      return;
    if (widget.cursorOpacityAnimates) {
